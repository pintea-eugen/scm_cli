########################################################################################################################
#!!
#! @description: Deletes one request in Micro Focus Service Management Automation X, using the REST API call.
#!
    ...
    - delete_entities:
        do:
          io.cloudslang.microfocus.service_management_automation_x.commons.delete_entities:
            ...
            - sso_token: '${sso_token}'
            - tenant_id: '${tenant_id}'
            - json_body: "${'[{\"entity_type\":\"Request\",\"properties\":{\"Id\":\"' + entity_id + '\"}}]'}"
  ...
  graph:
    steps:
      delete_entities:
        ...
        'y': 150
        navigate:
          65180936-860f-7c79-581f-8b4782ae7dc8:
            targetId: 94c40d4d-25a8-49a3-1a72-292a120e56bc
            port: SUCCESS
    results:
      SUCCESS:
        94c40d4d-25a8-49a3-1a72-292a120e56bc:
          x: 400
          'y': 150
