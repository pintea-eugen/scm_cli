########################################################################################################################
#!!
#! @description: Delete entities in Micro Focus Service Management Automation X, using the REST API call.
#!
...
#! @input json_body: The JSON format for the entity to be deleted.
    ...
    - post_ems_entity:
        do:
          io.cloudslang.base.http.http_client_post:
            ...
            - body: "${'{\"entities\": ' + json_body + ',  \"operation\": \"DELETE\"}'}"
            - content_type: application/json
        publish:
          - request_result: '${return_result}'
          - error_message
          - status_value: FAILED
        navigate:
  ...
  graph:
    steps:
      ...
      is_status_ok:
        ...
        'y': 250
        navigate:
          fa97562a-662b-8fa4-898e-1157efe816c3:
            targetId: 292433cc-8f19-1bd1-1e53-b84609aac322
            port: SUCCESS
      get_meta_completion_status:
        x: 399
        'y': 250
      get_error_details:
        ...
        'y': 377
        navigate:
          09e4f538-9fb9-86e2-477c-f0a3f6c7a0be:
            targetId: 740e14e2-f02c-3513-b0b8-c050ff45e3f9
            port: SUCCESS
    results:
      FAILURE:
        740e14e2-f02c-3513-b0b8-c050ff45e3f9:
          x: 1300
          'y': 250
      SUCCESS:
        292433cc-8f19-1bd1-1e53-b84609aac322:
          x: 1000
          'y': 125
